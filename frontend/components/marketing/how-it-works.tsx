...
const STEPS = [
  {
    ...
    body:
      "Type a question — “best time for whale-watching in Mirissa?”, “what to pack for Horton Plains?” — and get a grounded, sourced answer with citations from a curated atlas.",
    accent: "jade",
  },
  {
    n: "02",
    ...
    body:
      "Tell us your dates, budget, group, and interests. The AI drafts a day-by-day plan you can swap, regenerate, or share by link — and it respects monsoons, crowd indexes, and travel time.",
    accent: "saffron",
  },
  {
    n: "03",
      ...
      <div className="container relative">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-base leading-relaxed text-ink-600">
            Built for the way travellers actually plan — short questions on
