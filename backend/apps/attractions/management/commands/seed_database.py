...
# ─────────────────────────── Districts ─────────────────────────────────
DISTRICTS: list[dict] = [
    {"name": "Colombo", "province": "Western", "lat": 6.9271, "lng": 79.8612, "climate": ClimateZone.WET, "peak": [12, 1, 2, 3, 7, 8], "yt": ["tcqMG8NZURc", "VSdZnrSwP8I", "hk85rk26fDQ"], "desc": "Sri Lanka's commercial capital — colonial-era streets, modern skyline, food markets and a 350-metre observation tower."},
    {"name": "Gampaha", "province": "Western", "lat": 7.0917, "lng": 79.9999, "climate": ClimateZone.WET, "peak": [12, 1, 2, 3], "yt": ["llA56UBNqBQ", "C62fuZeo2so", "tgcQpHK6wyQ"], "desc": "Greater Colombo's leafy hinterland — Henarathgoda Botanical Gardens, river cruises and rural Buddhist heritage."},
    {"name": "Kalutara", "province": "Western", "lat": 6.5854, "lng": 79.9607, "climate": ClimateZone.WET, "peak": [12, 1, 2, 3], "yt": ["33xDujp7GmE", "x7RpolqXIEo", "g8_HPmV8AME"], "desc": "Coast-and-river district just south of Colombo — the Kalutara Bodhi shrine, river-mouth surfing and palm-lined beaches."},
    {"name": "Kandy", "province": "Central", "lat": 7.2906, "lng": 80.6337, "climate": ClimateZone.INTERMEDIATE, "peak": [1, 2, 3, 7, 8], "yt": ["iYNweZN2qPo", "BaoSjXdyNGY", "WJldB3xYTHI"], "desc": "The hill-country royal capital and home of the Sacred Tooth Relic — temples, lake walks, and the Esala Perahera pageant."},
    {"name": "Matale", "province": "Central", "lat": 7.4675, "lng": 80.6234, "climate": ClimateZone.INTERMEDIATE, "peak": [5, 6, 7, 8, 9], "yt": ["KL1NZgAIVIM", "BfLU2yvW2Ek", "gvDRZMOW4o8"], "desc": "The cultural triangle's gateway — Sigiriya, Dambulla cave temple, spice gardens and ancient Buddhist sites."},
    {"name": "Nuwara Eliya", "province": "Central", "lat": 6.9497, "lng": 80.7891, "climate": ClimateZone.INTERMEDIATE, "peak": [1, 2, 3, 4, 8], "yt": ["kCrakG35qis", "L803cf7duq0", "cTIR-907xS0"], "desc": "'Little England' — colonial bungalows at 1,900 m, mist-soaked tea estates, Horton Plains and Gregory Lake."},
    {"name": "Galle", "province": "Southern", "lat": 6.0535, "lng": 80.2210, "climate": ClimateZone.WET, "peak": [11, 12, 1, 2, 3], "yt": ["jBZVnrk06qw", "i8FCX3mDm8Y", "Rl7AsWX5Lk8"], "desc": "UNESCO-walled Dutch fort, surf coves, turtle beaches and the south coast's most photogenic stretch."},
    {"name": "Matara", "province": "Southern", "lat": 5.9485, "lng": 80.5353, "climate": ClimateZone.WET, "peak": [12, 1, 2, 3, 4], "yt": ["RwerNQISf_k", "7dFyYaI5g8s", "HbSEE7BUAOg"], "desc": "Mirissa's whales and surf, Weherahena temple, Polhena snorkelling and the Star Fort."},
    {"name": "Hambantota", "province": "Southern", "lat": 6.1241, "lng": 81.1185, "climate": ClimateZone.DRY, "peak": [2, 3, 4, 5, 6, 7], "yt": ["VQCfjUmHKGI", "2yzyFEYR4EU", "i75to7Pihfw"], "desc": "Yala safari country, salt pans, Bundala wetlands and the dry-zone south coast — leopards, elephants and flamingos."},
    {"name": "Jaffna", "province": "Northern", "lat": 9.6615, "lng": 80.0255, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8, 9], "yt": ["AGbvoCfY1KQ", "71mv4JpE0dc", "-NfyZ43u7kc"], "desc": "Tamil cultural heartland — Nallur Kovil, Dutch fort, the islands of Karaitivu and the long causeway to Delft."},
    {"name": "Kilinochchi", "province": "Northern", "lat": 9.3961, "lng": 80.4036, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8], "yt": ["K7P_cLimo3E", "vfy6Nn1nuk0", "xpupX8r35PI"], "desc": "Inland Northern district rebuilding after the war — Iranamadu tank, palmyra plantations and lesser-visited temples."},
    {"name": "Mannar", "province": "Northern", "lat": 8.9810, "lng": 79.9047, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8], "yt": ["ukTnYlv_Cfk", "nmF4ky2PJXo", "dA-0KzXAuPA"], "desc": "Bridge of Adam's Bridge / Rama's Setu, baobab trees, wild donkeys and Talaimannar's lighthouse on the Indian crossing."},
    {"name": "Vavuniya", "province": "Northern", "lat": 8.7514, "lng": 80.4971, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8], "yt": ["wjMecjUPtnE", "ajr6LsKmsFU", "AE1dKGnyBFg"], "desc": "Crossroads town between the cultural triangle and Jaffna — tanks, Madhu road and quiet rural Buddhism."},
    {"name": "Mullaitivu", "province": "Northern", "lat": 9.2671, "lng": 80.8142, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8], "yt": ["RY31Myp0onY", "dfDJ8ur1aZQ", "dW7BU3CCOxc"], "desc": "The eastern Vanni coast — pristine beaches at Nayaru, Nanthikadal lagoon and one of the country's wildest stretches."},
    {"name": "Batticaloa", "province": "Eastern", "lat": 7.7170, "lng": 81.7000, "climate": ClimateZone.DRY, "peak": [4, 5, 6, 7, 8, 9], "yt": ["RyJbPbry-j0", "oyMPzbi-I-4", "O2JfdKyVNlg"], "desc": "Sun-drenched east-coast town with a Dutch fort, lagoon kallady bridge, and Pasikudah's bath-warm reef beach."},
    {"name": "Ampara", "province": "Eastern", "lat": 7.2916, "lng": 81.6747, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8, 9], "yt": ["lYOf55wRIhI", "n5sGC2W6njc", "ZuizY-dmVrQ"], "desc": "Eastern wildlife and surf — Arugam Bay's point break, Lahugala's elephants and Buddhangala's hilltop forest temple."},
    {"name": "Trincomalee", "province": "Eastern", "lat": 8.5874, "lng": 81.2152, "climate": ClimateZone.DRY, "peak": [4, 5, 6, 7, 8, 9], "yt": ["celUKrnMuEg", "uuh9b6ZG_Rg", "_UWAbRHR4O4"], "desc": "Natural deep-water harbour, Hindu pilgrimage at Koneswaram, blue whales offshore and Nilaveli's white sand."},
    {"name": "Kurunegala", "province": "North Western", "lat": 7.4863, "lng": 80.3623, "climate": ClimateZone.INTERMEDIATE, "peak": [1, 2, 3, 7, 8], "yt": ["te3i4kTtD3U", "TqF8BxmoJXo", "1vBlToJxhJU"], "desc": "Coconut triangle gateway — Yapahuwa rock fortress, Athugala 'elephant rock' and Panduwasnuwara medieval ruins."},
    {"name": "Puttalam", "province": "North Western", "lat": 8.0408, "lng": 79.8394, "climate": ClimateZone.DRY, "peak": [2, 3, 4, 5, 6, 7], "yt": ["wTdi45kjvI8", "EriAm6yPsDw", "H7XOHk5qcYQ"], "desc": "Wilpattu safari country, salt-pan flamingos at Kalpitiya, kitesurfing lagoon and Munneswaram pilgrimages."},
    {"name": "Anuradhapura", "province": "North Central", "lat": 8.3114, "lng": 80.4037, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8, 9], "yt": ["qLzCSAcu8Aw", "AmquI9BPUfc", "2kQIV1lYdKA"], "desc": "Sri Lanka's first ancient capital and a UNESCO sacred city — colossal stupas, the Sri Maha Bodhi tree, Ritigala forest."},
    {"name": "Polonnaruwa", "province": "North Central", "lat": 7.9403, "lng": 81.0188, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8, 9], "yt": ["M_6mSRs1sxY", "eWCHxAkH4Gc", "abWyCycB1M4"], "desc": "The medieval royal capital, UNESCO listed — Gal Vihara's reclining Buddha, Parakrama Samudra and Minneriya elephants."},
    {"name": "Badulla", "province": "Uva", "lat": 6.9934, "lng": 81.0550, "climate": ClimateZone.INTERMEDIATE, "peak": [1, 2, 3, 4, 8], "yt": ["9cT0WJAjnBA", "z7_7lJ1-dBM", "2vq4uwWIEZE"], "desc": "Ella, Lipton's seat, Nine Arches viaduct and the most loved hill-country backpacker valley in Sri Lanka."},
    {"name": "Moneragala", "province": "Uva", "lat": 6.8714, "lng": 81.3506, "climate": ClimateZone.DRY, "peak": [5, 6, 7, 8], "yt": ["rWRl1Zb-64k", "jnyU296_QT0", "kAiAUZvuTn0"], "desc": "Wild-east province — Maligawila's giant standing Buddha, Kataragama pilgrim road and Yala's quieter eastern boundary."},
    {"name": "Ratnapura", "province": "Sabaragamuwa", "lat": 6.6828, "lng": 80.3992, "climate": ClimateZone.WET, "peak": [1, 2, 3, 7, 8], "yt": ["toq_pKYawx0", "VZuZ8rTFP0E", "70pEe5Bwfeo"], "desc": "'City of Gems' — Sinharaja rainforest, Adam's Peak's southern trail and gem-mining lore."},
    {"name": "Kegalle", "province": "Sabaragamuwa", "lat": 7.2513, "lng": 80.3464, "climate": ClimateZone.INTERMEDIATE, "peak": [1, 2, 3, 7, 8], "yt": ["kBSRwoZpAXE", "vX7uv24jbok", "9M68O-88FG0"], "desc": "Pinnawala elephant orphanage, Bible Rock (Bathalegala), Utuwankanda outlaw legends and tea-plus-rubber estates."},
]
